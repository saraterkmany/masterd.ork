...
<body>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container1">
            ...
            <div class="pro">
                <a href="kitchen.php">
                    <img src="img/kitchen1.1.jpeg" alt="">
        ...
        <div class="pro">
            <a href="office.php"> <img src="img/kitchen1.1.jpeg" alt="">
                <div class="description">
                    <span>Office</span>
            </a>
        ...
        <div class="pro">
            <a href="bedroom.php"> <img src="img/kitchen1.1.jpeg" alt="">
                <div class="description">
                    <span> Bed Room</span>
            </a>
        ...
        <div class="pro">
            <a href="tvUnits.php"> <img src="img/kitchen1.1.jpeg" alt="">
                <div class="description">
                    <span>Tv units</span>
            </a>
        ...
        <div class="pro">
            <a href="per.php"> <img src="img/kitchen1.1.jpeg" alt="">
                <div class="description">
                    <span>pergola</span>
            </a>
