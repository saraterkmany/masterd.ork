...
<body>
    <div class="header" onclick="toggleMenu()" id="header">
        ...
        <div class="navBar" id="navBar">
            ...
            <ul class="navigation-items" id="nav-links">
                ...
                <li> <a class="active" href="about.php">حول</a></li>
    ...
    <section class="about">
        ...
        <div style="padding-right: 40px;">
            ...
            <p>حمص: مدينة التاريخ والنهضة
                تُعدّ حمص واحدة من أعرق المدن السورية التي تحمل بين شوارعها عبق التاريخ وأصالة الثقافة.
                ومع مرور الزمن، تأثرت المدينة بالعديد من التحديات
                ، لكن تبقى إرادة البناء والنهضة هي القوة المحركة.</p>
        </div>
    </section>
    <section class="about2">
        ...
        <div>
            <h2>
                استعادة الماضي لبناء المستقبل


            </h2>
            <p>اليوم، نجد أنفسنا في مرحلة جديدة من الترميم وإعادة الإعمار، حيث يساهم المواطنون
                في إعادة الحياة لمباني المدينة وترميم معالمها
                التاريخية، لتعود حمص إلى مجدها السابق،
                مدينةً نابضة بالحياة وجمالها الفريد.
                <br>
                الترميم هو استثمار في الماضي والمستقبل، ليظل الجمال المعماري والحضاري لحمص في أبهى صورة.
